 ...
 * <ul>
 *   <li>{@link org.eclipse.wazaabi.engine.edp.tests.model.company.impl.CompanyImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.wazaabi.engine.edp.tests.model.company.impl.CompanyImpl#getDepartments <em>Departments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompanyImpl extends EObjectImpl implements Company {
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectResolvingEList<Department>(Department.class, this, CompanyPackage.COMPANY__DEPARTMENTS);
		}
		return departments;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompanyPackage.COMPANY__NAME:
				return getName();
			case CompanyPackage.COMPANY__DEPARTMENTS:
