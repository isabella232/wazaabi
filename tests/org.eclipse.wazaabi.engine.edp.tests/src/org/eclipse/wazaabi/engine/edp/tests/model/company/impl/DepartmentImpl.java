 ...
 * <ul>
 *   <li>{@link org.eclipse.wazaabi.engine.edp.tests.model.company.impl.DepartmentImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link org.eclipse.wazaabi.engine.edp.tests.model.company.impl.DepartmentImpl#getEmployees <em>Employees</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DepartmentImpl extends EObjectImpl implements Department {
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompanyPackage.DEPARTMENT__NUMBER, oldNumber, number));
	}
	...
	public EList<Employee> getEmployees() {
		if (employees == null) {
			employees = new EObjectResolvingEList<Employee>(Employee.class, this, CompanyPackage.DEPARTMENT__EMPLOYEES);
		}
		return employees;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompanyPackage.DEPARTMENT__NUMBER:
				return getNumber();
