...
public class TestImageRuleImagePushButton extends AbstractTestImageRuleImageButton{
	
	private PushButton widget;
	
	@Override
	public void before() {
		super.before();
		widget = CoreWidgetsFactory.eINSTANCE.createPushButton();
	}
