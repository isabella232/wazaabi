...
public class TestLayoutSwitchFromExpandToTabbedLayout extends AbstractTestExpandLayout {
	...
	public org.eclipse.swt.widgets.Widget createWazaabiExpandLayoutWithOneExpandContainingOneButtonAndChangeExpandRuleToTabbedRule(boolean before){ //creates a wazaabi container with buttons in it
		...
		container.getStyleRules().remove(0);
...
//		}
	...
	public void testSwitchFromExpandLayoutRuleToTabbedLayoutRuleBeforeSetContentsEqualsSWTCTabFolder() throws IOException{
		...
		org.eclipse.swt.widgets.Widget tabFolder = createWazaabiExpandLayoutWithOneExpandContainingOneButtonAndChangeExpandRuleToTabbedRule(true);
		...
		Assert.assertTrue(EXPANDLABEL.equals(tab1.getText()));
	...
	public void testSwitchFromExpandLayoutRuleToTabbedLayoutRuleAfterSetContentsEqualsSWTCTabFolder() throws IOException{
		createSWTTabbedLayoutWithOneTabContainingOneButton();
		org.eclipse.swt.widgets.Widget tabFolder = createWazaabiExpandLayoutWithOneExpandContainingOneButtonAndChangeExpandRuleToTabbedRule(false);
		Assert.assertTrue(tabFolder instanceof CTabFolder);
		Assert.assertNotNull(((CTabFolder)tabFolder).getItem(0));
		Assert.assertTrue(((CTabFolder)tabFolder).getItem(0) instanceof CTabItem);
		CTabItem tab1 = ((CTabFolder) tabFolder).getItem(0);
	...
	public void testSwitchFromExpandLayoutRuleToTabbedLayoutRuleWithTwoTabsBeforeSetContentsEqualsSWTCTabFolder() throws IOException{
		...
		Assert.assertTrue(((CTabFolder)tabFolder).getItem(0) instanceof CTabItem);
		CTabItem tab1 = ((CTabFolder) tabFolder).getItem(0);
		Assert.assertTrue(tab1.getText().equals(EXPANDLABEL));
		...
		Assert.assertTrue(tab2.getText().equals(EXPANDLABEL2));
