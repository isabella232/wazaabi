 ...
 * @generated
 */
public class WazaabiE4Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WazaabiE4Package.WAZAABI_PART: {
				WazaabiPart wazaabiPart = (WazaabiPart)theEObject;
				T result = caseWazaabiPart(wazaabiPart);
				if (result == null) result = casePart(wazaabiPart);
				if (result == null) result = casePartSashContainerElement(wazaabiPart);
				if (result == null) result = caseStackElement(wazaabiPart);
				if (result == null) result = caseContribution(wazaabiPart);
				if (result == null) result = caseContext(wazaabiPart);
				if (result == null) result = caseUILabel(wazaabiPart);
				if (result == null) result = caseHandlerContainer(wazaabiPart);
				if (result == null) result = caseDirtyable(wazaabiPart);
				if (result == null) result = caseBindings(wazaabiPart);
				if (result == null) result = caseWindowElement(wazaabiPart);
				if (result == null) result = caseUIElement(wazaabiPart);
				if (result == null) result = caseApplicationElement(wazaabiPart);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Wazaabi Part</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Wazaabi Part</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWazaabiPart(WazaabiPart object) {
		return null;
	}
