...
public class LabelEditPart extends AbstractComponentEditPart {
	...
	public static final String LOOKANDFEEL_PROPERTY_NAME = "lookandfeel"; //$NON-NLS-1$
	...
	protected void refreshFeaturesAndStyles() {
		...
		refreshUniqueStyleRule(LOOKANDFEEL_PROPERTY_NAME);
	}
}
