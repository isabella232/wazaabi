...
public interface EditPartListener {
	...
	public class Stub implements EditPartListener {
		/**
		 * @see org.eclipse.wazaabi.engine.core.gef.EditPartListener#childAdded(EditPart, int)
		 */
		public void childAdded(EditPart child, int index) {
		}

		/**
		 * @see org.eclipse.wazaabi.engine.core.gef.EditPartListener#partActivated(EditPart)
		 */
		public void partActivated(EditPart editpart) {
		}

		/**
		 * @see org.eclipse.wazaabi.engine.core.gef.EditPartListener#partDeactivated(EditPart)
		 */
		public void partDeactivated(EditPart editpart) {
		}

		/**
		 * @see org.eclipse.wazaabi.engine.core.gef.EditPartListener#removingChild(EditPart, int)
		 */
