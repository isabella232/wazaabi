...
public class CoreExtrasAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CoreExtrasSwitch<Adapter> modelSwitch =
		new CoreExtrasSwitch<Adapter>() {
			@Override
			public Adapter caseCellEditor(CellEditor object) {
				return createCellEditorAdapter();
			}
			@Override
			public Adapter caseTextCellEditor(TextCellEditor object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.core.extras.CellEditor <em>Cell Editor</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.core.extras.TextCellEditor <em>Text Cell Editor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
