...
public class CoreHandlersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoreHandlersPackage.REFRESH_ACTION: {
				RefreshAction refreshAction = (RefreshAction)theEObject;
				T result = caseRefreshAction(refreshAction);
				if (result == null) result = caseOperation(refreshAction);
				if (result == null) result = caseDeferred(refreshAction);
				if (result == null) result = caseExecutable(refreshAction);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Refresh Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Refresh Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRefreshAction(RefreshAction object) {
		return null;
	}
