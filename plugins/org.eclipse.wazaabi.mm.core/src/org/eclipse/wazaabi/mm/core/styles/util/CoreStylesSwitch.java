...
public class CoreStylesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case CoreStylesPackage.BOX_LAYOUT_RULE: {
                BoxLayoutRule boxLayoutRule = (BoxLayoutRule)theEObject;
                T result = caseBoxLayoutRule(boxLayoutRule);
                if (result == null) result = caseLayoutRule(boxLayoutRule);
                if (result == null) result = caseStyleRule(boxLayoutRule);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
	...
	/**
     * Returns the result of interpreting the object as an instance of '<em>Box Layout Rule</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Box Layout Rule</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseBoxLayoutRule(BoxLayoutRule object) {
        return null;
    }
