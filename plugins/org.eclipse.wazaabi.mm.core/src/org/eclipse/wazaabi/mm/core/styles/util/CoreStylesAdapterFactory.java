...
public class CoreStylesAdapterFactory extends AdapterFactoryImpl {
	...
	protected CoreStylesSwitch<Adapter> modelSwitch =
		new CoreStylesSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseBoxLayoutRule(BoxLayoutRule object) {
                return createBoxLayoutRuleAdapter();
            }
            @Override
	...
	/**
     * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.core.styles.BoxLayoutRule <em>Box Layout Rule</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
