 ...
 *
 *
 * @see org.eclipse.wazaabi.mm.core.widgets.CoreWidgetsPackage#getAbstractButton()
 * @model abstract="true"
 *        annotation="http://www.wazaabi.org/style/property/definition name='text' type='package=http://www.wazaabi.org/core/styles\r\nEClass=StringRule'"
 *        annotation="http://www.wazaabi.org/style/property/definition name='image' type='package=http://www.wazaabi.org/core/styles\r\nEClass=ImageRule'"
 * @generated
 */
public interface AbstractButton extends AbstractComponent {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
