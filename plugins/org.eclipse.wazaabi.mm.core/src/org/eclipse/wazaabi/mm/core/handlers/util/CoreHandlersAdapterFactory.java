...
public class CoreHandlersAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
	protected CoreHandlersSwitch<Adapter> modelSwitch =
		new CoreHandlersSwitch<Adapter>() {
            @Override
            public Adapter caseRefreshAction(RefreshAction object) {
                return createRefreshActionAdapter();
            }
            @Override
	...
	/**
     * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.core.handlers.RefreshAction <em>Refresh Action</em>}'.
     * <!-- begin-user-doc -->
