 ...
 * @generated
 */
public class PartsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PartsPackage.PAGE: {
				Page page = (Page)theEObject;
				T result = casePage(page);
				if (result == null) result = caseContainer(page);
				if (result == null) result = caseAbstractComponent(page);
				if (result == null) result = caseWidget(page);
				if (result == null) result = caseAnnotatedElement(page);
				if (result == null) result = caseEventDispatcher(page);
				if (result == null) result = caseStyledElement(page);
				if (result == null) result = caseContext(page);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PartsPackage.PROXY: {
				Proxy proxy = (Proxy)theEObject;
				T result = caseProxy(proxy);
				if (result == null) result = caseAbstractComponent(proxy);
				if (result == null) result = caseWidget(proxy);
				if (result == null) result = caseAnnotatedElement(proxy);
				if (result == null) result = caseEventDispatcher(proxy);
				if (result == null) result = caseStyledElement(proxy);
				if (result == null) result = caseContext(proxy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
