...
public class SWTStylesPackageImpl extends EPackageImpl implements SWTStylesPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGridDataRule_MinimumHeight(), ecorePackage.getEInt(), "minimumHeight", "0", 0, 1, GridDataRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGridDataRule_MinimumWidth(), ecorePackage.getEInt(), "minimumWidth", "0", 0, 1, GridDataRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
