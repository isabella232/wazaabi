...
public class CoreThemesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoreThemesPackage.BLANK_WIDGET: {
				BlankWidget blankWidget = (BlankWidget)theEObject;
				T result = caseBlankWidget(blankWidget);
				if (result == null) result = caseWidget(blankWidget);
				if (result == null) result = caseAnnotatedElement(blankWidget);
				if (result == null) result = caseEventDispatcher(blankWidget);
				if (result == null) result = caseStyledElement(blankWidget);
				if (result == null) result = caseContext(blankWidget);
