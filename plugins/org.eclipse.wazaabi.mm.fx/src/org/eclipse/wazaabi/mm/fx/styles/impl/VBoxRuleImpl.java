...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VBox Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.wazaabi.mm.fx.styles.impl.VBoxRuleImpl#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link org.eclipse.wazaabi.mm.fx.styles.impl.VBoxRuleImpl#getMargin <em>Margin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VBoxRuleImpl extends LayoutRuleImpl implements VBoxRule {
    /**
    ...
    protected EClass eStaticClass() {
        return FXStylesPackage.Literals.VBOX_RULE;
    }
    ...
    public void setSpacing(int newSpacing) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FXStylesPackage.VBOX_RULE__SPACING, oldSpacing, spacing));
    }
    ...
    public void setMargin(int newMargin) {
        ...
        margin = newMargin;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FXStylesPackage.VBOX_RULE__MARGIN, oldMargin, margin));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case FXStylesPackage.VBOX_RULE__SPACING:
                return getSpacing();
            case FXStylesPackage.VBOX_RULE__MARGIN:
                return getMargin();
        }
