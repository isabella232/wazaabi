...
import org.eclipse.wazaabi.ide.propertysheets.forms.complexcelleditors.LayoutDataCellEditor;
import org.eclipse.wazaabi.ide.propertysheets.viewer.TargetChangeListener;

public class LayoutDataEditingHelper extends AbstractEditingHelper {
	...
	public CellEditor getCellEditor(Control control, Object element) {
		return new LayoutDataCellEditor((Composite) control);
	}
