...
public class FillLayoutForm extends AbstractDetailsSection {
	...
	protected Control createSection(Section parent,
		...
		Composite orientation = createRadioGroupField(orientationSection,
				"Orientation",
				SWTStylesPackage.Literals.FILL_LAYOUT_RULE__TYPE,
		...
		getFormToolkit().createLabel(marginsContainerLeft, "Height:");
		Text marginTop = createTextField(marginsContainerLeft, "",
				SWTStylesPackage.Literals.FILL_LAYOUT_RULE__MARGIN_HEIGHT,
		...
		getFormToolkit().createLabel(marginsContainerCenter, "Width:");
		Text marginBottom = createTextField(marginsContainerCenter,
				"margin bottom:",
				SWTStylesPackage.Literals.FILL_LAYOUT_RULE__MARGIN_WIDTH,
				TEXT_TO_INT_BINDING, targetChangeListener);
		...
		Text marginLeft = createTextField(marginsContainerRight, "",
				SWTStylesPackage.Literals.FILL_LAYOUT_RULE__SPACING,
				TEXT_TO_INT_BINDING, targetChangeListener);
