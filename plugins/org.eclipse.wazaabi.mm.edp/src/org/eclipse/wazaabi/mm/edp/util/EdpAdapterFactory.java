 ...
 * @generated
 */
public class EdpAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected EdpSwitch<Adapter> modelSwitch =
    new EdpSwitch<Adapter>()
    {
      @Override
      ...
      @Override
      public Adapter caseContextContent(ContextContent object)
      {
        return createContextContentAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.edp.ContextContent <em>Context Content</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createContextContentAdapter()
  {
    return null;
  }
