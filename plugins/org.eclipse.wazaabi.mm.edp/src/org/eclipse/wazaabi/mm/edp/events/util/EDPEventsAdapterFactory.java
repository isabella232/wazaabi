...
public class EDPEventsAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected EDPEventsSwitch<Adapter> modelSwitch =
    new EDPEventsSwitch<Adapter>()
    {
      @Override
      ...
      @Override
      public Adapter caseContentChangedEvent(ContentChangedEvent object)
      {
        return createContentChangedEventAdapter();
      }
      @Override
      ...
      @Override
      public Adapter casePropertyChangedEvent(PropertyChangedEvent object)
      {
        return createPropertyChangedEventAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.edp.events.PathEvent <em>Path Event</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.edp.events.ContentChangedEvent <em>Content Changed Event</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.edp.events.Event <em>Event</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.wazaabi.mm.edp.events.PropertyChangedEvent <em>Property Changed Event</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
