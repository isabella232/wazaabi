...
public class SWTScaleView extends
		org.eclipse.wazaabi.engine.swt.commons.views.SWTScaleView {

	private final FormToolkit formToolkit;

	public SWTScaleView(FormToolkit formToolkit) {
	...
	//
	// final org.eclipse.swt.widgets.Scale scale = formToolkit.creates(
