...
import org.eclipse.wazaabi.engine.swt.commons.views.SWTCheckBoxView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTContainerView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTLabelView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTMenuComponentView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTProgressBarView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTPushButtonView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTRadioButtonView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTScaleView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTSeparatorView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTSliderView;
import org.eclipse.wazaabi.engine.swt.commons.views.SWTSpinnerView;
...
public class FormsWidgetViewFactory implements WidgetViewFactory {
	...
	public FormsWidgetViewFactory() {
		System.out
				.println("-----------------> FormsWidgetViewFactory instanciated");
	}
