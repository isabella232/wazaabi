...
public class StyleRuleTableViewer extends AbstractTableViewer {
	//
	//
	// private final List<TargetChangeListener> listeners = new
	// ArrayList<TargetChangeListener>();
	// private GraphicalHelperFactory graphicalHelperFactory = new
	// GraphicalHelperFactory();
	// int hoverIndex = -1;
	...
	//
	// private StyleRuleDescriptorFactory styleRuleDescriptorFactory = new
	// StyleRuleDescriptorFactory();
	...
	// PropertyNameContentProposalProvider(
	...
	protected IContentProvider getContentProvider() {
		return new ContentProvider((StyleRule) getBlankRow());
	}
