...
public class DemoContainer {
	...
	public static void main(String[] args) {
		...
		Container rootContainer = CoreWidgetsFactory.eINSTANCE
				.createContainer();
		GridLayoutRule fillLayout = SWTStylesFactory.eINSTANCE
				.createGridLayoutRule();
		fillLayout.setPropertyName("layout");
		rootContainer.getStyleRules().add(fillLayout);

		// Create the button
		Container buttonContainer = CoreWidgetsFactory.eINSTANCE
				.createContainer();
		FillLayoutRule buttonLayout = SWTStylesFactory.eINSTANCE
				.createFillLayoutRule();
		buttonLayout.setPropertyName("layout");
		buttonContainer.getStyleRules().add(buttonLayout);

		PushButton toggleButton = CoreWidgetsFactory.eINSTANCE
				.createPushButton();
		...
		Container mainContainer = CoreWidgetsFactory.eINSTANCE
				.createContainer();
		...
		ExpandRule expandStyle1 = CoreStylesFactory.eINSTANCE
				.createExpandRule();
		...
		GridLayoutRule gridLayout1 = SWTStylesFactory.eINSTANCE
				.createGridLayoutRule();
		...
		ImageRule wazaabiLogoImage = CoreStylesFactory.eINSTANCE
				.createImageRule();
		...
		HyperlinkRule wazaabiHyperlink = CoreStylesFactory.eINSTANCE
				.createHyperlinkRule();
		...
		ExpandRule expandStyle2 = CoreStylesFactory.eINSTANCE
				.createExpandRule();
		...
		GridLayoutRule gridLayout2 = SWTStylesFactory.eINSTANCE
				.createGridLayoutRule();
		...
		FillLayoutRule sexContainerFillLayout = SWTStylesFactory.eINSTANCE
				.createFillLayoutRule();
		...
		RadioButton maleRadioButton = CoreWidgetsFactory.eINSTANCE
				.createRadioButton();
		maleRadioButton.setText("Female");
		sexContainer.getChildren().add(maleRadioButton);

		RadioButton femaleRadioButton = CoreWidgetsFactory.eINSTANCE
				.createRadioButton();
		...
		TextComponent firstnameText = CoreWidgetsFactory.eINSTANCE
				.createTextComponent();
		tab2.getChildren().add(firstnameText);

		GridDataRule firstnameGriddataRule = SWTStylesFactory.eINSTANCE
				.createGridDataRule();
		...
		TextComponent lastnameText = CoreWidgetsFactory.eINSTANCE
				.createTextComponent();
		tab2.getChildren().add(lastnameText);
		GridDataRule lastnameGriddataRule = SWTStylesFactory.eINSTANCE
				.createGridDataRule();
		...
		Container contactContainer = CoreWidgetsFactory.eINSTANCE
				.createContainer();
		RowLayoutRule contactContainerRowLayout = SWTStylesFactory.eINSTANCE
				.createRowLayoutRule();
		...
		GridDataRule contactGriddataRule = SWTStylesFactory.eINSTANCE
				.createGridDataRule();
		...
		RadioButton phoneRadio = CoreWidgetsFactory.eINSTANCE
				.createRadioButton();
		phoneRadio.setText("Phone");
		contactContainer.getChildren().add(phoneRadio);

		RadioButton mailRadio = CoreWidgetsFactory.eINSTANCE
				.createRadioButton();
		mailRadio.setText("Phone");
		contactContainer.getChildren().add(mailRadio);

		RadioButton pigeonRadio = CoreWidgetsFactory.eINSTANCE
				.createRadioButton();
		...
		GridDataRule commentsGriddataRule = SWTStylesFactory.eINSTANCE
				.createGridDataRule();
		...
		TextComponent commentsText = CoreWidgetsFactory.eINSTANCE
				.createTextComponent();
		commentsText.getStyleRules().add(commentsGriddataRule);
		tab2.getChildren().add(commentsText);
		BooleanRule multilineComments = CoreStylesFactory.eINSTANCE
				.createBooleanRule();
		...
		PushButton addMeButton = CoreWidgetsFactory.eINSTANCE
				.createPushButton();
		...
		//
		// FillLayoutRule fillLayout3 =
		// SWTStylesFactory.eINSTANCE.createFillLayoutRule();
		// fillLayout3.setPropertyName("layout");
		// tab3.getStyleRules().add(fillLayout3);

		// TextComponent text =
		// CoreWidgetsFactory.eINSTANCE.createTextComponent();
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("ui",
